...
DRIVER_REFRESH_INTERVAL = 100

START_PAGE_NUMBER = 1
END_PAGE_NUMBER = 2500 
TOTAL_PAGES = 0
LOG_LEVEL = "INFO"
...
SEARCH_PAGE_URL = {
    "Batdongsan": f"{BASE_URL['Batdongsan']}/ban-nha-rieng",
...
URLS_CSV_PATH = {
    "Batdongsan": OUTPUT_DIR / "batdongsan_listing_urls.csv",
...
QUALITY_LEVELS = [
    (
        ...
        [
            ...
            "nhà tạm",
            "chủ yếu lấy đất",
            "có nhà nhưng không đáng giá",
            "không tính giá trị nhà",
            "nhà cấp 4 cũ",
            "nhà xuống cấp",
            "giá trị đất là chính",
            "bán đất",
            "sắp sập",
            "đập đi xây lại",
        ],
    ...
    (
        ...
        [
            ...
            "tiện nghi",
            "không lỗi phong thủy",
            "không lổi phong thủy",
            "không lỗi phong thuỷ",
            "không lổi phong thuỷ",
            "còn bảo hành",
            "nhà chất lượng tốt",
            "xây kiên cố",
            "xây chắc chắn",
